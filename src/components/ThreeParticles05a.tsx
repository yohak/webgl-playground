...
export type ThreeParticles05aProps = {};

export const ThreeParticles05a: FC<ThreeParticles05aProps> = ({}) => {
...
const init = (canvas: HTMLCanvasElement): (() => void) => {
  ...
  const showItem = (index: number) => {
    ...
    const tween = Tween24.tween(prop, 0.5, Ease24._4_QuartOut, { opacity: lineOpacity });
    tween.onUpdate(() => {
  ...
  const onClickCanvas = () => {
    ...
    Tween24.serial(
      ...
      Tween24.func(() => showItem(nextIndex)).delay(0.8),
      Tween24.func(() => {
